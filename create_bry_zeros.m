...
%            5.20.18 --> Updated FeP bry time and conditions.
%            8.31.18 --> Cleaned up fid paths
%=========================================================================%
%


function create_bry_zeros(fname)
...
%    FeP_time   = 96;
    ...
    % Particulate iron
    nccreate(fname,'FeP_time', ...
            'Dimensions',{'FeP_time' FeD_time}, ... 
            'Datatype','double', ...
            'Format','netcdf4');
    ncwriteatt(fname,'FeP_time','cycle_length',365.25);
    ncwriteatt(fname,'FeP_time','long_name','Open boundary conditions time');
    ncwriteatt(fname,'FeP_time','units','days since 1900-01-01 00:00:00');
    ncwriteatt(fname,'FeP_time','field','FeD_time, scalar, series');
    ...
    % analytical functions.  Only set biological variables to
    % zero (emulating passive tracers), since we don't want to disrupt the
    % circulation.
    %----------------------------------------------------------------------    
    %
    
    % bry_time still a scalar here
    CONST_VAL_EW=zeros(eta_rho,s_rho,bry_time);
    CONST_VAL_NS=zeros(xi_rho,s_rho,bry_time);
    ...
    % NO3
    NO3_west  = CONST_VAL_EW;
    NO3_east  = CONST_VAL_EW;
    NO3_north = CONST_VAL_NS;
    NO3_south = CONST_VAL_NS;

    % NH4
    NH4_west  = CONST_VAL_EW;
    NH4_east  = CONST_VAL_EW;
    NH4_north = CONST_VAL_NS;
    NH4_south = CONST_VAL_NS;

    % Phytoplankton
    Phytoplankton_west  = CONST_VAL_EW;
    Phytoplankton_east  = CONST_VAL_EW;
    Phytoplankton_north = CONST_VAL_NS;
    Phytoplankton_south = CONST_VAL_NS;

    % Diatoms
    Diatoms_west  = CONST_VAL_EW;
    Diatoms_east  = CONST_VAL_EW;
    Diatoms_north = CONST_VAL_NS;
    Diatoms_south = CONST_VAL_NS;

    % Bacteria
    Bacteria_west  = CONST_VAL_EW;
    Bacteria_east  = CONST_VAL_EW;
    Bacteria_north = CONST_VAL_NS;
    Bacteria_south = CONST_VAL_NS;

    % Chlorophyll
   Chlorophyll_west  = CONST_VAL_EW;
   Chlorophyll_east  = CONST_VAL_EW;
   Chlorophyll_north = CONST_VAL_NS;
   Chlorophyll_south = CONST_VAL_NS;


    % ChlD
   ChlD_west  = CONST_VAL_EW;
   ChlD_east  = CONST_VAL_EW;
   ChlD_north = CONST_VAL_NS;
   ChlD_south = CONST_VAL_NS;

    % DON
   DON_west  = CONST_VAL_EW;
   DON_east  = CONST_VAL_EW;
   DON_north = CONST_VAL_NS;
   DON_south = CONST_VAL_NS;

    % DOC
    DOC_west  = CONST_VAL_EW;
    DOC_east  = CONST_VAL_EW;
    DOC_north = CONST_VAL_NS;
    DOC_south = CONST_VAL_NS;

    % DetN
    DetN_west  = CONST_VAL_EW;
    DetN_east  = CONST_VAL_EW;
    DetN_north = CONST_VAL_NS;
    DetN_south = CONST_VAL_NS;

    % DetC
    DetC_west  = CONST_VAL_EW;
    DetC_east  = CONST_VAL_EW;
    DetC_north = CONST_VAL_NS;
    DetC_south = CONST_VAL_NS;

    % Silica
    Silica_west  = CONST_VAL_EW;
    Silica_east  = CONST_VAL_EW;
    Silica_north = CONST_VAL_NS;
    Silica_south = CONST_VAL_NS;

    % LDetN
    LDetN_west  = CONST_VAL_EW;
    LDetN_east  = CONST_VAL_EW;
    LDetN_north = CONST_VAL_NS;
    LDetN_south = CONST_VAL_NS;

    % LDetC
    LDetC_west  = CONST_VAL_EW;
    LDetC_east  = CONST_VAL_EW;
    LDetC_north = CONST_VAL_NS;
    LDetC_south = CONST_VAL_NS;

    % LDetS
    LDetS_west  = CONST_VAL_EW;
    LDetS_east  = CONST_VAL_EW;
    LDetS_north = CONST_VAL_NS;
    LDetS_south = CONST_VAL_NS;

    % Microzooplankton
   Microzooplankton_west  = CONST_VAL_EW;
   Microzooplankton_east  = CONST_VAL_EW;
   Microzooplankton_north = CONST_VAL_NS;
   Microzooplankton_south = CONST_VAL_NS;

    % Mesozooplankton
    Mesozooplankton_west  = CONST_VAL_EW;
    Mesozooplankton_east  = CONST_VAL_EW;
    Mesozooplankton_north = CONST_VAL_NS;
    Mesozooplankton_south = CONST_VAL_NS;

    % Dissolved iron
    FeD_west  = CONST_VAL_EW;
    FeD_east  = CONST_VAL_EW;
    FeD_north = CONST_VAL_NS;
    FeD_south = CONST_VAL_NS;

    % Particulate iron
    FeP_west  = CONST_VAL_EW;
    FeP_east  = CONST_VAL_EW;
    FeP_north = CONST_VAL_NS;
    FeP_south = CONST_VAL_NS;
    ...
    % Particulate iron
   ncwrite(fname,'FeP_time',FeP_time);
